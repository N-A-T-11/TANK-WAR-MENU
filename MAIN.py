...
def play():
    while True:
        ...
        PLAY_TEXT = get_font(30).render("PLAYER 1", True, "White")
        PLAY_RECT = PLAY_TEXT.get_rect(center=(90, 130))
        PLAY_TEXT2 = get_font(30).render("PLAYER 2", True,"White")
        PLAY_RECT2=PLAY_TEXT2.get_rect(center=(850,130))

        SCREEN.blit(PLAY_TEXT, PLAY_RECT)
        SCREEN.blit(PLAY_TEXT2, PLAY_RECT2)

        PLAY_BACK = Button(image=None, pos=(850, 50),
                            text_input="MAIN MENU", font=get_font(40), base_color="White", hovering_color="Green")
...
def options():
    while True:
     ...
     #PLAYER NAME BOARDS :
        #CONT_P1 = get_font(35).render("PLAYER 1 ",True,"Green")
        #P1_RECT = CONT_P1.get_rect(center=(220,130))
        #CONT_P2 = get_font(35).render("PLAYER 2 ",True,"Red")
        #P2_RECT = CONT_P2.get_rect(center=(800,130))
     ...
     #BLIT FUNCTIONS
        ...
        #SCREEN.blit(CONT_P1,P1_RECT) #PLAYER NAME BOARDS
        #SCREEN.blit(CONT_P2,P2_RECT)
